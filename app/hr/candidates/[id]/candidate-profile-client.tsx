...
import { updateCandidateNotes } from '@/app/hr/actions';
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="space-y-6">
          ...
          <Card className="border-border bg-card/60 p-5 backdrop-blur">
            ...
            <div className="space-y-2">
              {applications.map((a) => (
                <Link key={a.id} href={a.job ? `/hr/jobs/${a.job.id}` : '#'} className="flex items-center justify-between rounded-lg border border-border px-3 py-2 text-xs transition hover:bg-secondary/50">
